...
NOTE: this file is taken from https://github.com/mseitzer/pytorch-fid/blob/master/fid_score.py
"""
import os
import pathlib
...
def _compute_statistics_of_path(path, model, batch_size, dims, cuda, interpolate=False):
